...
<body>
    <header>
        <div class="container-fluid">
            <span class="logo">
                <img class="logo-icon" src="./logo google.png" alt="logo">
            </span>
        ...
        <?php
            ...
            $questions = [
                    ...
                    [
                        ...
                        <p>Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel <a href='http://google.com'> Centro Google per la sicurezza online.</a></p>
                    ...
                    [
                        ...
                        'risposta' => "<p>Il tuo account &egrave; associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
                        <ol>
                        <li>La societ&agrave; consociata Google che offre i servizi, tratta le tue informazioni ed &egrave; responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due societ&agrave; seguenti:
                        <ol type='a'>
                        ...
                        <li>La versione dei termini che regola il nostro rapporto, che pu&ograve; variare in base alle leggi locali.</li>
                        </ol>
                        <p>Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla societ&agrave; consociata che li offre o dal paese a cui &egrave; associato il tuo account.</p>
                        <h3>Stabilire il paese associato al tuo account</h3>
                        <p>Quando crei un nuovo Account Google, lo associamo a un paese in base a dove &egrave; stato creato. Per quanto riguarda gli account creati almeno un anno fa, usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui hai trascorso pi&ugrave; tempo nell'ultimo anno.</p>
        ...
        <div class="row">
            <div class="col-10 mx-auto">
                <?php foreach ($questions as $question){ ?>
                    ...
                    <p> <?php echo $question['risposta']?> </p>
                <?php } ?>
